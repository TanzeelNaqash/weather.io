    ...
    <footer className="footer">
      <div className="box-container">
        ...
        <div className="box">
          ...
          <hr />
          <br />
          <a href="#"><i className="fas fa-angle-right"></i>FAQs</a>
      ...
      <div className="copyright">&copy; Copyright @ <span id="currentYear"></span> <span><a href="./">weather.io</a></span> | All Rights Reserved! <br /> <span> developed by:<a href="https://github.com/TanzeelNaqash/" target="_blank">TanzeelNaqash</a></span></div>
